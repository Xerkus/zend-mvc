...
class ServiceListenerFactory implements FactoryInterface
{
    ...
    protected $defaultServiceConfig = [
        ...
        'factories'  => [
            ...
            'HttpMethodListener'             => 'Zend\Mvc\Container\HttpMethodListenerFactory',
            'HttpRouteNotFoundStrategy'      => RouteNotFoundStrategyFactory::class,
            'HttpViewManager'                => 'Zend\Mvc\Container\HttpViewManagerFactory',
            'InjectTemplateListener'         => 'Zend\Mvc\Container\InjectTemplateListenerFactory',
            'PaginatorPluginManager'         => 'Zend\Mvc\Container\PaginatorPluginManagerFactory',
            'Request'                        => 'Zend\Mvc\Container\RequestFactory',
            'Response'                       => 'Zend\Mvc\Container\ResponseFactory',
            'ViewHelperManager'              => 'Zend\Mvc\Container\ViewHelperManagerFactory',
            View\Http\DefaultRenderingStrategy::class => DefaultRenderingStrategyFactory::class,
            'ViewFeedStrategy'               => 'Zend\Mvc\Container\ViewFeedStrategyFactory',
            'ViewJsonStrategy'               => 'Zend\Mvc\Container\ViewJsonStrategyFactory',
            'ViewManager'                    => 'Zend\Mvc\Container\ViewManagerFactory',
            'ViewResolver'                   => 'Zend\Mvc\Container\ViewResolverFactory',
            'ViewTemplateMapResolver'        => 'Zend\Mvc\Container\ViewTemplateMapResolverFactory',
            'ViewTemplatePathStack'          => 'Zend\Mvc\Container\ViewTemplatePathStackFactory',
            'ViewPrefixPathStackResolver'    => 'Zend\Mvc\Container\ViewPrefixPathStackResolverFactory',
